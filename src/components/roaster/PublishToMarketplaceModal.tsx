  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/70 flex items-center justify-center p-4 sm:p-6">
      <div className="relative bg-white rounded-2xl max-w-lg w-full shadow-xl border border-slate-200 overflow-hidden my-8">
        <div className="bg-[#1E2333] text-white px-6 py-5 flex items-start justify-between">
          <div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">Berat Kemasan (gram)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">Jumlah Pack</label>
              <input
                type="number"
                value={totalPacks}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">Harga / Pack (Rp)</label>
              <input
                type="number"
                value={pricePerPack}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">SCA Cupping Score</label>
              <input
                type="number"
                step="0.1"
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">Resting (hari)</label>
              <input
                type="number"
                value={restingDays}
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1">Tasting Notes (pisahkan koma)</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1">Rekomendasi Brew (pisahkan koma)</label>
            <input
              type="text"
