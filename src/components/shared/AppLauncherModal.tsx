...
export const AppLauncherModal: React.FC<AppLauncherModalProps> = ({
  ...
  const FLOW_APPS = [
    ...
    },
    {
      ...
      title: 'Sourcing Ceri',
      subtitle: 'Pengadaan Ceri & Sortasi Petani',
    ...
    },
    {
      ...
      title: 'Gudang & Silo Stok',
      subtitle: 'Stok Ceri, Green Bean & Limbah',
    ...
    },
    {
      ...
      title: 'Processing 7-Stage',
      subtitle: 'Work Orders Fermentasi & Olah',
    ...
    {
      id: 'processor_history',
      title: 'Riwayat & Transaksi',
      subtitle: 'Audit Trail & Ledger Produksi',
